...
class EighthViewController: UIViewController {
    ...
    @objc private func downButtonTapped() {
        ...
        navigationController?.pushViewController(ninthVC, animated: true)
        makeAlert(titleInput: "Press Down Button One More Time!", messageInput: "Hero is trying to get away from dangerous creatures, help him!")
    }
